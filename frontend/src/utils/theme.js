/**
 * theme.js - Central configuration for application styling
 * 
 * This file contains design tokens and theme configuration for the application.
 * It provides consistent colors, spacing, typography, and other design elements
...
// Export default theme object that combines all tokens
const theme = {
  colors,
  spacing,
  typography,
